...
# Simple quaternion operations to avoid pybullet_utils dependency
def quaternion_multiply(q1, q2):
    """Multiply two quaternions (x, y, z, w format like pybullet)."""
    x1, y1, z1, w1 = q1
    x2, y2, z2, w2 = q2
    return np.array([
...
def quaternion_inverse(q):
    """Return the inverse of a quaternion (x, y, z, w format like pybullet)."""
    x, y, z, w = q
...
def QuaternionRotatePoint(point, quat):
  ...
  q_point_rotated = quaternion_multiply(
      quaternion_multiply(quat, q_point), quat_inv)
